      ...
      <>
        ...
        <div className="relative">
          <section id="#top" className="sticky z-6 top-0 min-h-screen dark:bg-darkgreen">
            <div className="min-h-screen min-w-full flex flex-auto flex-col items-center justify-center p-10" style={{
          ...
          <div className="sticky top-0 z-5 min-h-screen min-w-full dark:bg-darkgreen">
            <div id="section-2" className="sticky flex flex-col justify-center items-center min-h-screen top-0 z-5 bg-gradient-to-br from-emerald-100 via-lime-100 to-yellow-100 dark:bg-darkgreen py-14">
              <h3 className="text-center pb-5 text-5xl bg-gradient-to-r from-lime-600 to-green-700 bg-clip-text text-transparent font-bold">Green de la Creme</h3>
          ...
          <div className="sticky z-4 top-0 h-screen flex bg-yellow-100 flex-col items-center justify-center text-white">
            <div className="text-gray-900 py-20 px-12 bg-white rounded-lg">
              <div className="w-full pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16 max-w-7xl">
                ...
                <div className="flex flex-row sm:px-5 gap-x-8 gap-y-16">
                  <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                    ...
                    <p className="bg-green-500 flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3 rounded-full uppercase">Care tips</p>
          ...
          <section className="sticky top-0 z-3 h-screen flex flex-col items-center bg-white justify-center text-white">
            <div className="py-8 px-12">
              <div className="bg-gradient-to-r from-teal-200 to-lime-200  mx-auto my-auto mt-auto mb-auto py-8 px-12 rounded-lg shadow-xl">
          ...
          <section className="sticky top-0 z-2 h-screen mx-auto mb-10 min-w-full">
            <section className="min-h-screen bg-gray-200 min-w-full">
              <div className="container mx-auto h-screen px-6 py-32 flex flex-col items-center justify-center">
                ...
                <div className="flex justify-center mb-4"> <Lottie animationData={team} className="w-2/6" /> </div>
                <div className="grid grid-cols-4 gap-20 px-10 md:grid-cols-2 xl:mt-16 xl:grid-cols-3 justify-items-center">
                  <div className="flex flex-col items-center rounded-xl bg-white shadow-lg shadow-darkgreen/18 border p-4 dark:border-gray-700 sm:p-6">
                  ...
                  <div className="flex flex-col items-center rounded-xl border bg-white shadow-lg shadow-darkgreen/18 p-4 dark:border-gray-700 sm:p-6">
