...
import { useGetOneAccountQuery } from './store/accountApi';
...
export default function Profile() {
  ...
  const { thread: threadData } = useGetThreadsQuery();
            ...
            <div className="px-6">
              ...
              <div className="text-center mt-2">
                ...
                <div className="text-xs mt-0 mb-2 text-slate-400 font-bold uppercase">
                  <i className="fas fa-map-marker-alt text-slate-400 opacity-75"></i>@stringgg
                </div>
                <div className="text-xs mt-0 mb-2 text-slate-400 font-bold uppercase">
