    ...
    <>
      <div className="bg-white max-w-[240px] drop-shadow rounded-xl">
        <div className="flex inline-start">
          <div className="drop-shadow-2xl p-4 rounded-2xl border-1 border-gray-50">
            <div className="flex flex-col">
              ...
              <div className=" flex flex-row space-x-4 items-center">
                <div className="flex-auto w-1/4">
                  <span>
                    <img alt="" className="flex fill-current" src="https://cdn.iconscout.com/icon/free/png-256/free-plant-45-112595.png?f=avif&w=256" />
                  </span>
                </div>
                <div className="flex-auto w-3/4">
                  <p className="text-[15px]">{randomJoke}</p>
                </div>
              </div>
            </div >
