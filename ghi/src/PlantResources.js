...
export default function PlantResources() {
  return (
    <>
      ...
      <h1 id="h1" className=' text-center absolute top-1/2 pt-3 left-1/2 -translate-x-1/2 -translate-y-1/2 font-bold text-7xl text-white '>Plant Resources</h1>
      <div id="slide"></div>
      <div className="grid grid-cols-3 pt-16 max-w-9xl" >
        <div className='flex justify-center'>
          <section className="col-start-1 col-span-1 mb-22 " >
            <div id="glass" className="my-8 pb-4 mb-44 glass rounded-lg shadow-xl dark:bg-gray-800 duration-300 hover:-translate-y-1">
              <img
                ...
                className="rounded-t h-64 w-full  object-cover " style={{ maxWidth: "100%" }} alt="Plants" />
              <p className="break-words p-4 max-w-lg text-xl font-semibold text-center indie leading-relaxed text-gray-800 dark:text-gray-300">
              ...
              <div className='flex justify-center'>
                <a href="https://www.youtube.com/watch?v=kk4-NzpbXxw" target="_blank" rel="noreferrer"
                  className="mx-auto px-5 py-2 font-extrabold text-md rounded-full text-stone-700  " style={{ background: 'linear-gradient(to top right, #00ffcc 0%, #99ff66 100%)' }}>
                  Watch
                </a>
              </div>
            </div>
        ...
        <div className='flex justify-center'>
          <section className="col-start-2 col-span-1 items-center justify-center mb-22">
            <div id="glass" className="my-8 pb-4 mb-44 glass rounded-lg shadow-xl dark:bg-gray-800 duration-300 hover:-translate-y-1">
              <img
        ...
        <div className='flex justify-center'>
          <section className="col-start-3 col-span-1 items-center justify-center mb-22">
            <div id="glass" className="my-8 pb-4 mb-44 glass rounded-lg shadow-xl dark:bg-gray-800 duration-300 hover:-translate-y-1">
              <img
            ...
            <div id="glass" className="my-8 pb-4 mb-44 glass rounded-lg shadow-xl dark:bg-gray-800 duration-300 hover:-translate-y-1">
              ...
              <div className='flex justify-center'>
                <a href="https://www.youtube.com/watch?v=pMzRIdPreaY&pp=ygVOICAgIDA6MDAgLyA5OjI5ICDigKIgSW50cm8gICA3IFRoaW5ncyBQbGFudCBFeHBlcnRzIERvIFRoYXQgWW91IFByb2JhYmx5IERvbid0" target="_blank"
                  className="mx-auto px-5 py-2 font-extrabold text-md rounded-full text-stone-700" rel="noreferrer" style={{ background: 'linear-gradient(to top right, #00ffcc 0%, #99ff66 100%)' }}>
                  Watch
                </a>
              </div>
            </div>
