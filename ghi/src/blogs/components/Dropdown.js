...
export default function Dropdown({ id }) {
  ...
  return (
    <div className="dropdown">
      <button tabIndex={0} className="mt-1 inline-block align-middle text-secondary-200 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        <img src={`${process.env.PUBLIC_URL}/images/more.png`} alt="dropdown" className="w-6 h-6" />
      </button>
