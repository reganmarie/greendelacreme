...
export default function Header({ token }) {
  ...
  return (
    <div className="navbar sticky !z-[999] min-h-[32px] bg-[#f8f8f6]">
      <div className="flex-1">
        <div className="mx-auto lottie normal-case text-xl">
          <Link to="/blogs">
      ...
      <div className="bg-[#f8f8f6] flex justify-center w-full top-0">
        <div className="flex flex-row justify-center items-center">
          ...
          <div className="header__icons flex basis-1/2 justify-center space-x-20">
            ...
            <Link to="/resources">
              <HeaderOption Icon={YardIcon} title="Resources" />
            </Link>
            <Link to="/forum">
      ...
      <div className="dropdown dropdown-end p-2">
        <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
          <div className="w-10 rounded-full">
            <img src="https://cdn-icons-png.flaticon.com/512/1010/1010298.png?w=1480&t=st=1679989297~exp=1679989[%E2%80%A6]e5f06a0c262d324e9c9cf24ba94b5d9a0bd9b9ffed7ff117cebef17" alt="" />
          </div>
        </label>
