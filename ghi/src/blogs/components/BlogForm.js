      ...
      <section className="bg-[#ffffff] shadow-md rounded-lg p-5 w-full border">
        ...
        <form onSubmit={handlePost}>
          ...
          <footer className="flex justify-end mt-1 relative">
            ...
            <button type="submit" className="flex items-center h-9 py-2 px-4 rounded-full text-sm bg-secondary-200 text-white shadow-md hover:bg-darkgreen font-semibold">Post
